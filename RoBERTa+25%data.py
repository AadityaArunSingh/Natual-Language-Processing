# -*- coding: utf-8 -*-
"""NLP 25% additional data

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1ucdPNJ0YE26ZgMPJ75NUksD5guOeq1PL
"""
...
df_metrics = df_metrics.drop(['micro avg', 'macro avg', 'weighted avg', 'accuracy'], errors='ignore')

# Bar plot
df_metrics[['precision', 'recall', 'f1-score']].plot(kind='bar', figsize=(10, 6))
plt.title('Token Classification Metrics per Entity Type')
plt.ylabel('Score')
